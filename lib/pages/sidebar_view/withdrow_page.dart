                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    '${_filteredList[index].transactionMobileNo}',
                                    textAlign: TextAlign.center,
                                  ),
                                ),
                                Expanded(
                                  child: Text(
                                    '${_filteredList[index].transactionSystem}',
                                    textAlign: TextAlign.center,
                                  ),
                                ),
                                Expanded(
                                  child: Text(
                                    '${_filteredList[index].amount}',
                                    textAlign: TextAlign.center,
                                  ),
                                ),
                                Expanded(
                                          ...
                                          firebaseProvider
                                            ...
                                            String requestedAmount =
                                                firebaseProvider
                                                    ...
                                                    .amount;
                                            String servicharge =
                                                firebaseProvider.rateDataList[0]
                                                    .serviceCharge;

                                            int refundAmount =
                                                int.parse(requestedAmount) +
                                                    int.parse(servicharge) +
                                                    int.parse(firebaseProvider
                                                        .userMainBalance);
                                            ...
                                            print(
                                                'User Main Balance: ${firebaseProvider.userMainBalance}');
                                            print('Refund $refundAmount');

                                            _refundWithDrawRequest(
                                                    firebaseProvider,
                                                    refundAmount,
                                                    index)
                                                .then((value) {
