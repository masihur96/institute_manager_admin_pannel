  ...
  customInit(FirebaseProvider firebaseProvider) {
    ...
    if (firebaseProvider.infoList.isEmpty) {
      firebaseProvider.getContactInfo().then((value) {
        setState(() {
          _email =
              TextEditingController(text: firebaseProvider.infoList[0].email);
          _phone =
              TextEditingController(text: firebaseProvider.infoList[0].phone);
          _address =
              TextEditingController(text: firebaseProvider.infoList[0].address);
          _fbLink =
              TextEditingController(text: firebaseProvider.infoList[0].fbLink);
          _youtubeLink = TextEditingController(
              text: firebaseProvider.infoList[0].youtubeLink);
          _twitterLink = TextEditingController(
              text: firebaseProvider.infoList[0].twitterLink);
          _instragramLink = TextEditingController(
              text: firebaseProvider.infoList[0].instagram);
          _linkedInLink = TextEditingController(
              text: firebaseProvider.infoList[0].linkedIn);
        });
      });
    } else {
      setState(() {
        ...
        _twitterLink = TextEditingController(
            text: firebaseProvider.infoList[0].twitterLink);
        _instragramLink =
            TextEditingController(text: firebaseProvider.infoList[0].instagram);
        _linkedInLink =
            TextEditingController(text: firebaseProvider.infoList[0].linkedIn);
      });
    }
  }
