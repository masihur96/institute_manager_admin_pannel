...
class TeacherJoiningPage extends StatefulWidget {
  @override
  _TeacherJoiningPageState createState() => _TeacherJoiningPageState();
}
...
//Image URL
    ...
    input.onChange.listen((event) {
      for (var image in input.files!) {
        ...
        reader.onLoadEnd.listen((event) async {
          ...
          } else if (selectedFrame == 'Certificate') {
            setState(() {
  ...
  Future<void> _submitData(PublicProvider publicProvider,
    ...
    await firebaseProvider.joinTeacherData(map).then((value) async {
      if (value) {
