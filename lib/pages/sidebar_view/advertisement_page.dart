...
import 'package:institute_manager_admin_pannel/model/file_DataModel.dart';
...
class _AdvertisementState extends State<Advertisement> {
  ...
  Widget build(BuildContext context) {
    ...
    if (counter == 0) {
      _customInit(
          firebaseProvider, firebaseProvider.advertisementList[0].videoUrl);
    }
    return Container(
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration:
                                        textFieldFormDecoration(size).copyWith(
                                      labelText: 'Title',
                                          ...
                                          if (firebaseProvider
                                            ...
                                            storageUploadTask.then((value) {
                                              ...
                                              taskSnapshot.ref
                                                ...
                                                _submitData(
                                                    firebaseProvider, uuid);
                                              });
                                            });
                                          } else {
                                            showToast(
                                                'You Have Already Five Videos');
                                          }
                                        },
                                        child: Container(
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  _customInit(
                                      firebaseProvider,
                                      firebaseProvider
                                          .advertisementList[index].videoUrl);
                                },
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Row(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(firebaseProvider
                                                    ...
                                                    .title),
                                                Text(
                                                    'Upload Date: ${firebaseProvider.advertisementList[index].date}'),
                                              ],
                                            ),
                                          ),
                                        ],
