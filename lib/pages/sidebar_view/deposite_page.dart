...
class _DepositePageState extends State<DepositePage> {
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      DateTime date = DateTime.fromMillisecondsSinceEpoch(
                          int.parse(
                              firebaseProvider.depositRequestList[index].date));
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    '${_filteredList[index].amount == '' ? '--' : _filteredList[index].amount}',
                                    textAlign: TextAlign.center,
                                  ),
                                ),
                                Expanded(
                                                    ...
                                                    TextButton(
                                                      ...
                                                      onPressed: () {
                                                        ...
                                                        firebaseProvider
                                                          ...
                                                          await _addDepositRequestBalance(
                                                              firebaseProvider,
                                                              updatableAmount,
                                                              index);
                                                        }).then((value) async {
                                                          await _transferedDepositRequestBalance(
                                                                  firebaseProvider,
                                                                  depositTextController
                                                                      .text,
                                                                  index)
  ...
  Future<void> _addDepositRequestBalance(FirebaseProvider firebaseProvider,
      int updatebleAmount, int? index) async {
