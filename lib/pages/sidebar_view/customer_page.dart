...
import 'package:institute_manager_admin_pannel/pages/pdf_all_customer.dart';
              ...
              child: Row(
                ...
                children: [
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.symmetric(
                                                vertical: 5.0),
                                            child: Text(
                                              'Are you confirm to delete this customer ?',
                                              style: TextStyle(
                                                  fontSize: 14,
                                                  color: Colors.black),
                                            ),
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        AllCustomerPDF.allCustomerPdf(_filteredList,
                            'Customer Details', context, publicProvider);
                      },
                      child: Text(
                        'Print',
                        style: TextStyle(
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                      ...
                                      child: deleteList.contains(index)
                                          ? Icon(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      width: 30,
                                      height: 30,
                                      child: _filteredList[index].imageUrl !=
                                              null
                                          ? Image.network(
                                  ...
                                  Expanded(
                                    child: TextButton(
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Refer Code: ${_filteredList[index].referCode}',
                                                                        style: TextStyle(
                                                                            fontSize:
                                                                                14,
                                                                            color:
                                                                    ...
                                                                    Text(
                                                                      'Refer Date: ${_filteredList[index].referDate}',
                                                                      style: TextStyle(
                                                                          fontSize:
                                                                              14,
                                                                          color:
                                                                    ...
                                                                    Text(
                                                                      'Refer Limit: ${_filteredList[index].referLimit}',
                                                                    ),
                                                                    Padding(
                                                                      padding: const EdgeInsets
                                                                              .symmetric(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Total Referee: ${_filteredList[index].numberOfReferred}',
                                                                        style: TextStyle(
                                                                            fontSize:
                                                                                14,
                                                                            color:
                                        ...
                                        child: Text(
                                          firebaseProvider
                                              .userList[index].numberOfReferred,
                                          textAlign: TextAlign.center,
                                  ...
                                  Expanded(
                                      child: Text(
                                    firebaseProvider.userList[index].level,
                                    textAlign: TextAlign.center,
                                  )),
                                  Expanded(
                                      child: Text(
                                    firebaseProvider
                                        .userList[index].mainBalance,
                                    textAlign: TextAlign.center,
                                  )),
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            'Start from: ${firebaseProvider.userList[index].lastInsurancePaymentDate}',
                                                                            style:
                                                                                TextStyle(fontSize: 14, color: Colors.black),
                                                                          ),
                                                                        ),
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            'Deposit Balance: ${firebaseProvider.userList[index].depositBalance}',
                                                                            style:
                                                                                TextStyle(fontSize: 14, color: Colors.black),
                                                                          ),
                                                                        ),
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            'Insurance Balance: ${firebaseProvider.userList[index].insuranceBalance}',
                                                                            style:
                                                                                TextStyle(fontSize: 14, color: Colors.black),
                                                                          ),
                                                                        ),
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            'Main Balance: ${firebaseProvider.userList[index].mainBalance}',
                                                                            style:
                                                                                TextStyle(fontSize: 14, color: Colors.black),
                                                                          ),
                                                                        ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              child: Image.asset(
                                                                                int.parse(firebaseProvider.userList[index].level) <= 99
                                                                                    ? 'assets/images/normal.png'
                                                                                    : int.parse(firebaseProvider.userList[index].level) < 199
                                                                                        ? 'assets/images/bronz.png'
                                                                                        : int.parse(firebaseProvider.userList[index].level) < 299
                                                                                            ? 'assets/images/silver.png'
                                                                                            : int.parse(firebaseProvider.userList[index].level) < 399
                                                                                                ? 'assets/images/gold.png'
                                                                                                : int.parse(firebaseProvider.userList[index].level) < 499
                                                                  ...
                                                                  TextButton(
                                                                      onPressed:
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          publicProvider.category =
                                                                              '';
                                                                          firebaseProvider.withdrawIndex =
                                                                              index;
                                                                        });
                                                                        Navigator.pop(
                                                                            context);
