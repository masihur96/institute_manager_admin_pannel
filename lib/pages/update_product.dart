            ...
            children: [
              ...
              Container(
                ...
                child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: firebaseProvider.productIndex == null
                            ...
                            children: [
                              Text('Subcategory: ',
                                  style: TextStyle(
                                      ...
                                      fontStyle: FontStyle.normal,
                                      fontSize: 15)),
                              subCategoryDropdownValue.isEmpty
                                  ? Container()
                                  : DropdownButtonHideUnderline(
                                      child: DropdownButton<String>(
                                        ...
                                        style: TextStyle(color: Colors.black),
                                        items:
                                            filterSubcategory.map((itemValue) {
                                          return DropdownMenuItem<String>(
                                            value: itemValue,
                                            child: Text(itemValue),
                                          );
