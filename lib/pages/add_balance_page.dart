      ...
      if (firebaseProvider.rateDataList.isNotEmpty) {
        setState(() {
          _serviceCharge = TextEditingController(
              text: firebaseProvider.rateDataList[0].serviceCharge);
          _videoRate = TextEditingController(
              text: firebaseProvider.rateDataList[0].videoRate);
        });
      }
    });
  }
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          border: new OutlineInputBorder(
                            ...
                            borderSide:
                                new BorderSide(width: 1, color: Colors.green),
                          ),
                        ),
                        maxLines: 1,
                      ),
