                                              ...
                                              child: Row(
                                                children: [
                                                  IconButton(
                                                      onPressed: () {
                                                        setState(() {
                                                          updateSubcategoryTextController =
        ...
        builder: (context) {
          return StatefulBuilder(builder: (context, setState) {
            return AlertDialog(
              ...
              content: Text('Are You Confirm to Delete This Subcategory'),
              actions: <Widget>[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    _isLoading
                        ...
                        : TextButton(
                            ...
                            onPressed: () async {
                              ...
                              firebaseProvider
                                  .batchDeleteSubcategory(id, oldText)
                                  .then((value) {
                                _filterSubCategoryList(dropdownValue);
                        ...
                        : TextButton(
                            ...
                            onPressed: () async {
                              ...
                              Map<String, String> mapData = {
                                'subCategory':
                                    updateSubcategoryTextController.text,
                                'id': id,
                              };
                              //  print(updateCategoryTextController.text);
                              firebaseProvider
                                  .batchUpdateSubcategory(mapData, oldText,
                                      updateSubcategoryTextController.text)
                                  .then((value) {
                                firebaseProvider.getSubCategory();
