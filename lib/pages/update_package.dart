...
// product Id from Product Page
  ...
  customInt(FirebaseProvider firebaseProvider) async {
    ...
    setState(() {
      titleTextController.text =
          firebaseProvider.packageList[firebaseProvider.packageIndex].title;
      descriptionTextController.text = firebaseProvider
          .packageList[firebaseProvider.packageIndex].description;
      priceTextController.text =
          firebaseProvider.packageList[firebaseProvider.packageIndex].price;
      discountTextController.text = firebaseProvider
          .packageList[firebaseProvider.packageIndex].discountAmount;
      quantityTextController.text =
          firebaseProvider.packageList[firebaseProvider.packageIndex].quantity;
      selectedPackageID =
          firebaseProvider.packageList[firebaseProvider.packageIndex].id;
      selectedPackageColor =
          firebaseProvider.packageList[firebaseProvider.packageIndex].colors;
      imageUrl =
          firebaseProvider.packageList[firebaseProvider.packageIndex].image;
      thumbnailURL =
          firebaseProvider.packageList[firebaseProvider.packageIndex].thumbnail;
  ...
  Widget productPickWidget(FirebaseProvider firebaseProvider,
        ...
        children: [
          ...
          Stack(children: [
            Container(
              // width: size.height*.4,
              height:
                  publicProvider.isWindows ? size.height * .6 : size.width * .6,
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                  border: Border.all(width: 1, color: Colors.grey)),
              child: convertedImages.isNotEmpty
                  ? Container(
                      child: Image.memory(
                        convertedImages[imageIndex!],
                        fit: BoxFit.cover,
                      ),
                    )
                  : convertedThumbnail.isNotEmpty
                      ? Container(
                          child: Image.memory(
                            convertedThumbnail[0],
                            fit: BoxFit.cover,
                          ),
                        )
                      : imageUrl.isNotEmpty
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: convertedThumbnail.isNotEmpty
                    ? Container(
                        padding: const EdgeInsets.all(8.0),
                        ...
                        child: Container(
                          ...
                          child: thumbnailURL.isNotEmpty
                              ? Image.network(firebaseProvider
                                  .packageList[firebaseProvider.packageIndex]
                                  .thumbnail)
                              : Container(),
                          height: publicProvider.isWindows
                              ? size.height * .2
              ...
              Container(
                ...
                child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: firebaseProvider.packageIndex == null
  ...
  Widget productDetailsWidget(FirebaseProvider firebaseProvider,
      PublicProvider publicProvider, Size size) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Column(
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        ListTile(
                                          ...
                                          subtitle: Text(
                                              '${ColorTools.colorCode(screenPickerColor)} '
                                                  ...
                                                  setState(() {
                                                    if (colorList.contains(
                                                      ...
                                                      colors.add(
                                                          screenPickerColor);
                                                      colorList.add(
                                                          '0x${ColorTools.colorCode(screenPickerColor)}');
                                                    }
                                                  });
                                                },
                                                width: 44,
