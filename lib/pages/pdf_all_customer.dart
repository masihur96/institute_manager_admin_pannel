...
class AllCustomerPDF {
  static Future<void> allCustomerPdf(List<UserModel> dataList, String title,
      BuildContext context, PublicProvider publicProvider) async {
                      ...
                      pw.Row(
                          ...
                          children: [
                            pw.Expanded(
                                child: pw.Container(
                              alignment: pw.Alignment.center,
                              child: pw.Text('${dataList[index].id}',
                                  textAlign: pw.TextAlign.center,
                                  style: normalTextStyle),
                            )),
                            pw.Expanded(
                                child: pw.Container(
                              alignment: pw.Alignment.center,
                              child: pw.Text(dataList[index].name!,
                                  textAlign: pw.TextAlign.center,
                                  style: normalTextStyle),
                            )),
                            pw.Expanded(
                            ...
                            pw.Expanded(
                                child: pw.Container(
                              alignment: pw.Alignment.center,
                              child: pw.Text(dataList[index].numberOfReferred!,
                                  textAlign: pw.TextAlign.center,
                                  style: normalTextStyle),
                            )),
                            pw.Expanded(
                                child: pw.Container(
                              alignment: pw.Alignment.center,
                              child: pw.Text(dataList[index].level!,
                                  textAlign: pw.TextAlign.center,
                                  style: normalTextStyle),
                            )),
                            pw.Expanded(
                                child: pw.Container(
                              alignment: pw.Alignment.center,
                              child: pw.Text(dataList[index].mainBalance!,
                                  textAlign: pw.TextAlign.center,
                                  style: normalTextStyle),
                            )),
                          ]),
                      pw.Divider(
                          height: 0.0, thickness: 0.5, color: PdfColors.grey)
                    ]);
                  }),
            ];
          }
