                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                '${firebaseProvider.withdrawHistoryList[index].id}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                            ...
                            Expanded(
                              child: Text(
                                '${firebaseProvider.withdrawHistoryList[index].transactionMobileNo}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: publicProvider.isWindows
                                      ? size.height * .02
                            ...
                            Expanded(
                              child: Text(
                                '${firebaseProvider.withdrawHistoryList[index].transactionSystem}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: publicProvider.isWindows
                                      ? size.height * .02
                            ...
                            Expanded(
                              child: Text(
                                '${firebaseProvider.withdrawHistoryList[index].amount}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: publicProvider.isWindows
                                      ? size.height * .02
