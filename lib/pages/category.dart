...
class _CategoryState extends State<Category> {
  ...
  Future<void> _submitCategoryData(FirebaseProvider firebaseProvider) async {
    final snapshot1 = await FirebaseFirestore.instance
        .collection('Category')
        .doc(categoryTextController.text)
        .get();
  ...
  Future<void> _displayTextInputDialog(String oldText, BuildContext context,
                    ...
                    _isLoading
                        ...
                        : TextButton(
                            ...
                            onPressed: () async {
                              ...
                              //  print(updateCategoryTextController.text);
                              firebaseProvider
                                  .batchUpdateCategory(mapData, oldText,
                                      updateCategoryTextController.text)
                                  .then((value) {
  ...
  Future<void> _displayDeleteDialog(String oldText, BuildContext context,
      FirebaseProvider firebaseProvider, String id) async {
    return showDialog(
        context: context,
        builder: (context) {
          return StatefulBuilder(builder: (context, setState) {
            return AlertDialog(
              ...
              content: Text('Are You Confirm to Delete This Category'),
              actions: <Widget>[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    _isLoading
                        ...
                        : TextButton(
                            ...
                            onPressed: () async {
                              ...
                              firebaseProvider
                                  .batchDeleteCategory(id, oldText)
                                  .then((value) {
                                firebaseProvider.getCategory();
