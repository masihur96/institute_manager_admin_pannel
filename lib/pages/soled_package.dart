                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                      ...
                                      setState(() {
                                        if (selectOrder.contains(index)) {
                                          ...
                                          selectOrderID.remove(
                                              _soldPackageFilteredList[index]
                                                  .id);
                                        } else {
                                ...
                                Expanded(
                                    child: Text(
                                  _soldPackageFilteredList[index].date!,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    fontSize: publicProvider.isWindows
                                        ? size.height * .02
                                ...
                                Expanded(
                                  child: Text(
                                    _soldPackageFilteredList[index].discount!,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: publicProvider.isWindows
                                          ? size.height * .02
                                ...
                                Expanded(
                                  child: Text(
                                    _soldPackageFilteredList[index].quantity!,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: publicProvider.isWindows
                                          ? size.height * .02
                                ...
                                Expanded(
                                  child: Text(
                                    _soldPackageFilteredList[index].status!,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: publicProvider.isWindows
                                          ? size.height * .02
