              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Image.network(
                      firebaseProvider
                          .userList[firebaseProvider.insuranceID].imageUrl,
                      fit: BoxFit.fill,
                    ),
                  ),
                  SizedBox(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        firebaseProvider
                            .userList[firebaseProvider.insuranceID].name,
                      ...
                      Padding(
                        ...
                        child: Text(
                          firebaseProvider
                              .userList[firebaseProvider.insuranceID].address,
                          style: TextStyle(fontSize: 14, color: Colors.black),
                        ),
                      ),
                      Text(firebaseProvider
                          .userList[firebaseProvider.insuranceID].phone),
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 18.0),
                        child: Text(
                          'Start from: ${firebaseProvider.userList[firebaseProvider.insuranceID].insuranceEndingDate}',
                          style: TextStyle(fontSize: 14, color: Colors.black),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 18.0),
                        child: Text(
                          'Ending Date: ${firebaseProvider.userList[firebaseProvider.insuranceID].insuranceEndingDate}',
                          style: TextStyle(fontSize: 14, color: Colors.black),
                        ),
                      ),
                      Text(
                        'Last Insurance Payment Date: ${firebaseProvider.userList[firebaseProvider.insuranceID].lastInsurancePaymentDate}',
                        style: TextStyle(fontSize: 14, color: Colors.black),
                      ),
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 18.0),
