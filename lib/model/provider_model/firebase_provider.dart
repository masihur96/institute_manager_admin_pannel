...
import 'package:institute_manager_admin_pannel/model/data_model/admin_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/advertisement_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/area_hub_model.dart';
...
import 'package:institute_manager_admin_pannel/model/data_model/depositeRequestModel.dart';
import 'package:institute_manager_admin_pannel/model/data_model/info_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/insurance_request_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/package_model.dart';
...
import 'package:institute_manager_admin_pannel/model/data_model/refer_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/set_rate_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/sub_category_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/withdraw_history_model.dart';
import 'package:institute_manager_admin_pannel/model/data_model/withdraw_request_model.dart';
...
class FirebaseProvider extends ChangeNotifier {
      ...
      await FirebaseFirestore.instance
        ...
        snapShot.docChanges.forEach((element) {
          ...
          final date = new DateTime.fromMillisecondsSinceEpoch(
              int.parse(element.doc['timeStamp']));
          day = date.day;
          month = date.month;
          year = date.year;
  ...
  Future<void> getStudents() async {
    try {
      await FirebaseFirestore.instance
        ...
        print('Student List: ${_studentList.length}');
        notifyListeners();
      });
    } catch (error) {
      print(error);
  ...
  Future<void> getProductOrder() async {
    try {
      ...
      await FirebaseFirestore.instance
        ...
        print(
            'Product Pending Order  List: ${_productPendingOrderList.length}');
        notifyListeners();
      });
    } catch (error) {
      print(error);
  ...
  Future<void> getInsuranceTransferredRequest() async {
    try {
      await FirebaseFirestore.instance
        ...
        print(
            'Insurance Transferred List: ${_insuranceTransferredRequestList.length}');
        notifyListeners();
      });
    } catch (error) {
      print(error);
  ...
  Future<bool> addStudentData(Map<String, dynamic> map) async {
    try {
      await FirebaseFirestore.instance
          .collection("Student")
          .doc(map['id'])
  ...
  Future<bool> joinTeacherData(Map<String, dynamic> map) async {
    try {
      await FirebaseFirestore.instance
          .collection("Teacher")
          .doc(map['id'])
  ...
  Future<bool> joinStuffData(Map<String, dynamic> map) async {
    try {
      await FirebaseFirestore.instance
          .collection("Stuff")
          .doc(map['id'])
  ...
  Future<bool> addDepositData(Map<String, dynamic> map, String id) async {
    try {
      await FirebaseFirestore.instance.collection("Users").doc(id).update(map);
      notifyListeners();
      return true;
    } catch (err) {
      print(err);
  ...
  Future<bool> updatePackageOrderStatus(
      Map<String, dynamic> map, int index) async {
  ...
  Future<bool> updateInsuranceStatusData(
      Map<String, dynamic> map, int index) async {
    ...
    try {
      await FirebaseFirestore.instance
        ...
        getInsurancePendingRequest()
            .then((value) => getInsuranceTransferredRequest());
      });
      notifyListeners();
      return true;
    } catch (err) {
  ...
  Future<bool> addDepositRequestAmount(
      Map<String, dynamic> map, int index) async {
    try {
      await FirebaseFirestore.instance
          .collection("Users")
  ...
  Future<bool> updateProductData(Map<String, dynamic> map) async {
    try {
      await FirebaseFirestore.instance
          .collection('Products')
          .doc(studentList[productIndex].id)
          .update(map);
      notifyListeners();
  ...
  Future<void> batchUpdateCategory(
      Map<String, String> map, String oldSubtext, String newSubText) async {
  ...
  Future<void> batchDeleteCategory(String id, String oldSubtext) async {
    WriteBatch batch = FirebaseFirestore.instance.batch();
    // print('Batch Category: $collectionName');
    // print('Batch Old Text : $oldSubtext');
    // print('Batch New Text : $newSubText');
  ...
  Future<void> batchUpdateSubcategory(
      Map<String, String> map, String oldSubtext, String newSubText) async {
    WriteBatch batch = FirebaseFirestore.instance.batch();
    // print('Batch Category: $collectionName');
    print('Batch Old Text : $oldSubtext');
  ...
  Future<void> batchDeleteSubcategory(String id, String oldSubtext) async {
    WriteBatch batch = FirebaseFirestore.instance.batch();
    // print('Batch Category: $collectionName');
    // print('Batch Old Text : $oldSubtext');
    // print('Batch New Text : $newSubText');
